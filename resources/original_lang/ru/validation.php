...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Дочерние порты',
        'send_to_ftp' => 'Отправить на FTP/SFTP',
        'max_speed' => 'максимальная скорость',
        'auto_status_change' => 'Автоматическое изменение статуса',
        'delivery_ac_duration' => 'Продолжительность доставки',
        'delivery_ac_radius' => 'Радиус доставки',
        'delivery_ac_status' => 'О состоянии доставки',
        'delivery_ac_started_at' => 'Начато изменение статуса доставки',
        'delivery_ac_finished_at' => 'Изменение статуса доставки завершено',
        'pickup_ac_duration' => 'Продолжительность получения',
        'pickup_ac_radius' => 'Радиус захвата',
        'pickup_ac_status' => 'Статус получения',
        'pickup_ac_started_at' => 'Начато изменение статуса самовывоза.',
        'pickup_ac_finished_at' => 'Изменение статуса получения завершено',
        'azure_maps_key' => 'Ключ Azure Maps',
        'lbs' => 'ЛБС',
        'skipped' => 'Пропущено',
        'datetime_format' => 'Формат даты и времени',
        'acceptable_time_from' => 'Приемлемое время от',
        'extend_period_if_not_found' => 'Продлить период, если не найдено',
        'present' => 'Подарок',
        'ignore_without_ignition' => 'Игнорировать, если зажигание выключено',
        'installation_date_default_today' => 'Дата установки сегодня по умолчанию',
        'phone_verification' => 'Проверка по телефону',
        'task_set_title' => 'Название набора задач',
        ...
        'inactive' => 'Неактивный',
        'sort_column' => 'Столбец сортировки по умолчанию',
        'connection' => 'Связь',
        'filename' => 'Имя файла',
        ...
        'here_political_view' => 'HERE.com политическая точка зрения',
        'unit_type' => 'Тип единицы измерения параметра',
        'case' => 'Случай',
        'zones' => 'Зоны',
        'drivers' => 'Драйверы',
        'refresh_token' => 'Обновить токен',
        'reset_blank' => 'Сбросить пустое значение',
        'tags' => 'Теги',
        'is_common' => 'Общий',
        'allow_expired_value' => 'Разрешить просроченное значение',
    ),
    ...
    'phone' => ':attribute должен быть действительным номером телефона.',
    'input_placeholder' => 'Вставлять',
    'datepicker_placeholder' => 'Выбирать',
    'select_placeholder' => 'Выбирать',
    'address_placeholder' => 'Выберите адрес',
    'invalid_export_type' => 'Выбранный тип экспорта недействителен.',
    'imei' => 'Неверный IMEI, возможные символы: AZ az 0-9 _ # -',
);