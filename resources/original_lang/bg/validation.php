...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Детски портове',
        'send_to_ftp' => 'Изпращане до FTP/SFTP',
        'max_speed' => 'максимална скорост',
        'auto_status_change' => 'Автоматична промяна на състоянието',
        'delivery_ac_duration' => 'Продължителност на доставката',
        'delivery_ac_radius' => 'Радиус на доставка',
        'delivery_ac_status' => 'Статус на доставка',
        'delivery_ac_started_at' => 'Промяната на статуса на доставка започна',
        'delivery_ac_finished_at' => 'Промяната на състоянието на доставката приключи',
        'pickup_ac_duration' => 'Продължителност на вземане',
        'pickup_ac_radius' => 'Радиус на пикап',
        'pickup_ac_status' => 'Състояние на получаване',
        'pickup_ac_started_at' => 'Промяната на статуса на получаване започна',
        'pickup_ac_finished_at' => 'Промяната на статуса на получаване приключи',
        'azure_maps_key' => 'Ключ на Azure Maps',
        'lbs' => 'LBS',
        'skipped' => 'Пропуснато',
        'datetime_format' => 'Формат за дата и час',
        'acceptable_time_from' => 'Приемливо време от',
        'extend_period_if_not_found' => 'Удължете периода, ако не бъде намерен',
        'present' => 'Настояще',
        'ignore_without_ignition' => 'Игнорирайте, ако запалването е изключено',
        'installation_date_default_today' => 'Датата на инсталиране днес по подразбиране',
        'phone_verification' => 'Телефонна проверка',
        'task_set_title' => 'Заглавие на комплекта задачи',
        'pickup_time' => 'Време за получаване',
        'delivery_time' => 'Време за доставка',
        'location_address' => 'Адрес',
        'location_time' => 'време',
        'date_range' => 'Период от време',
        'inactive' => 'Неактивен',
        'sort_column' => 'Колона за сортиране по подразбиране',
        'connection' => 'Връзка',
        'filename' => 'Име на файла',
        'tokens_count' => 'Жетоните се броят',
        'confirmation' => 'Потвърждение',
        'change_password' => 'Промяна на паролата',
        'new_password' => 'Нова парола',
        'here_political_view' => 'HERE.com политически възглед',
        'unit_type' => 'Тип параметър единица',
        'case' => 'Случай',
        'zones' => 'Зони',
        'drivers' => 'Шофьори',
        'refresh_token' => 'Опресняване на токена',
        'reset_blank' => 'Нулиране на празна стойност',
        'tags' => 'Етикети',
        'is_common' => 'Често срещани',
        'allow_expired_value' => 'Позволи изтекла стойност',
    ),
    ...
    'phone' => ':attribute трябва да е валиден телефонен номер.',
    'input_placeholder' => 'Поставете',
    'datepicker_placeholder' => 'Изберете',
    'select_placeholder' => 'Изберете',
    'address_placeholder' => 'Изберете адрес',
    'invalid_export_type' => 'Избраният тип експортиране не е валиден.',
    'imei' => 'Невалиден IMEI, възможни знаци: AZ az 0-9 _ # -',
);