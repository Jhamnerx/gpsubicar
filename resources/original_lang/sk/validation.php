...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Detské porty',
        'send_to_ftp' => 'Odoslať na FTP/SFTP',
        'max_speed' => 'Maximálna rýchlosť',
        'auto_status_change' => 'Automatická zmena stavu',
        'delivery_ac_duration' => 'Trvanie doručenia',
        'delivery_ac_radius' => 'Polomer doručenia',
        'delivery_ac_status' => 'Stav doručenia',
        'delivery_ac_started_at' => 'Začala sa zmena stavu doručenia',
        'delivery_ac_finished_at' => 'Zmena stavu doručenia dokončená',
        'pickup_ac_duration' => 'Trvanie vyzdvihnutia',
        'pickup_ac_radius' => 'Polomer odberu',
        'pickup_ac_status' => 'Stav vyzdvihnutia',
        'pickup_ac_started_at' => 'Začala sa zmena stavu vyzdvihnutia',
        'pickup_ac_finished_at' => 'Zmena stavu vyzdvihnutia dokončená',
        'azure_maps_key' => 'Kľúč Azure Maps',
        'lbs' => 'LBS',
        'skipped' => 'Preskočené',
        'datetime_format' => 'Formát dátumu a času',
        'acceptable_time_from' => 'Prijateľný čas od',
        'extend_period_if_not_found' => 'Predĺžte obdobie, ak sa nenájde',
        'present' => 'Súčasnosť',
        'ignore_without_ignition' => 'Ignorujte, ak je zapaľovanie vypnuté',
        'installation_date_default_today' => 'Predvolený dátum inštalácie dnes',
        'phone_verification' => 'Telefonické overenie',
        'task_set_title' => 'Názov súboru úloh',
        'pickup_time' => 'Čas vyzdvihnutia',
        'delivery_time' => 'Dodacia lehota',
        'location_address' => 'Adresa',
        'location_time' => 'čas',
        'date_range' => 'Rozsah dátumov',
        'inactive' => 'Neaktívne',
        'sort_column' => 'Predvolený stĺpec triedenia',
        'connection' => 'Pripojenie',
        'filename' => 'Názov súboru',
        'tokens_count' => 'Počet žetónov',
        'confirmation' => 'Potvrdenie',
        'change_password' => 'Zmeniť heslo',
        'new_password' => 'Nové heslo',
        'here_political_view' => 'Politický pohľad TU.com',
        'unit_type' => 'Typ jednotky parametra',
        'case' => 'Prípad',
        'zones' => 'Zóny',
        'drivers' => 'Vodiči',
        'refresh_token' => 'Obnoviť token',
        'reset_blank' => 'Obnoviť prázdnu hodnotu',
        'tags' => 'Značky',
        'is_common' => 'Bežné',
        'allow_expired_value' => 'Povoliť expirovanú hodnotu',
    ),
    ...
    'starts_with' => 'Atribút :attribute musí začínať jedným z nasledujúcich výrazov: :values .',
    'json' => ':attribute musí byť platný reťazec JSON.',
    'phone' => ':attribute musí byť platné telefónne číslo.',
    'input_placeholder' => 'Vložiť',
    'datepicker_placeholder' => 'Vyberte',
    'select_placeholder' => 'Vyberte',
    'address_placeholder' => 'Vyberte adresu',
    'invalid_export_type' => 'Vybratý typ exportu nie je platný.',
    'imei' => 'Neplatné IMEI, možné znaky: AZ az 0-9 _ # -',
);