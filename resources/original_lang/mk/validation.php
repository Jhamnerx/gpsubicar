...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Детски пристаништа',
        'send_to_ftp' => 'Испрати до FTP/SFTP',
        'max_speed' => 'максимална брзина',
        'auto_status_change' => 'Автоматска промена на статусот',
        'delivery_ac_duration' => 'Времетраење на испорака',
        'delivery_ac_radius' => 'Радиус на испорака',
        'delivery_ac_status' => 'Статус на достава',
        'delivery_ac_started_at' => 'Промената на статусот на испорака започна',
        'delivery_ac_finished_at' => 'Промената на статусот на испорака заврши',
        'pickup_ac_duration' => 'Времетраење на подигање',
        'pickup_ac_radius' => 'Радиус на пикап',
        'pickup_ac_status' => 'Статус на пикап',
        'pickup_ac_started_at' => 'Промената на статусот на подигање започна',
        'pickup_ac_finished_at' => 'Промената на статусот на подигање е завршена',
        'azure_maps_key' => 'Копче Azure Maps',
        'lbs' => 'ЛБС',
        'skipped' => 'Прескокнат',
        'datetime_format' => 'Формат за датум на време',
        'acceptable_time_from' => 'Прифатливо време од',
        'extend_period_if_not_found' => 'Продолжете го периодот ако не се најде',
        'present' => 'Присутни',
        'ignore_without_ignition' => 'Игнорирајте ако палењето е исклучено',
        'installation_date_default_today' => 'Стандардно, датумот на инсталација денес',
        'phone_verification' => 'Потврда на телефонот',
        'task_set_title' => 'Наслов на сет на задачи',
        'pickup_time' => 'Време на подигање',
        'delivery_time' => 'Време на испорака',
        'location_address' => 'Адреса',
        'location_time' => 'Време',
        'date_range' => 'Опсег на датуми',
        'inactive' => 'Неактивен',
        'sort_column' => 'Стандардна колона за сортирање',
        'connection' => 'Поврзување',
        'filename' => 'Име на датотека',
        'tokens_count' => 'Се бројат токените',
        'confirmation' => 'Потврда',
        'change_password' => 'Променете ја лозинката',
        'new_password' => 'Нова лозинка',
        'here_political_view' => 'HERE.com политички став',
        'unit_type' => 'Тип на параметарска единица',
        'case' => 'Случај',
        'zones' => 'Зони',
        'drivers' => 'Возачи',
        'refresh_token' => 'Освежи токен',
        'reset_blank' => 'Ресетирај празна вредност',
        'tags' => 'Ознаки',
        'is_common' => 'Заеднички',
        'allow_expired_value' => 'Дозволи истечена вредност',
    ),
    ...
    'starts_with' => ':attribute мора да започне со едно од следниве: :values .',
    'json' => ':attribute мора да биде валидна JSON низа.',
    'phone' => ':attribute мора да биде важечки телефонски број.',
    'input_placeholder' => 'Вметнете',
    'datepicker_placeholder' => 'Изберете',
    'select_placeholder' => 'Изберете',
    'address_placeholder' => 'Изберете адреса',
    'invalid_export_type' => 'Избраниот тип на извоз не е валиден.',
    'imei' => 'Неважечки IMEI, можни знаци: AZ az 0-9 _ # -',
);