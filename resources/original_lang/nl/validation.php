...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Kinderpoorten',
        'send_to_ftp' => 'Verzenden naar FTP/SFTP',
        'max_speed' => 'Maximale snelheid',
        'auto_status_change' => 'Automatische statuswijziging',
        'delivery_ac_duration' => 'Leveringsduur',
        'delivery_ac_radius' => 'Bezorgradius',
        'delivery_ac_status' => 'Aflever status',
        'delivery_ac_started_at' => 'Wijziging van de leveringsstatus gestart',
        'delivery_ac_finished_at' => 'Wijziging van leveringsstatus voltooid',
        'pickup_ac_duration' => 'Ophaalduur',
        'pickup_ac_radius' => 'Ophaalradius',
        'pickup_ac_status' => 'Ophaalstatus',
        'pickup_ac_started_at' => 'Wijziging van de afhaalstatus gestart',
        'pickup_ac_finished_at' => 'Wijziging van de afhaalstatus voltooid',
        'azure_maps_key' => 'Azure Maps-sleutel',
        'lbs' => 'LBS',
        'skipped' => 'Overgeslagen',
        'datetime_format' => 'Datetime-formaat',
        'acceptable_time_from' => 'Aanvaardbare tijd vanaf',
        'extend_period_if_not_found' => 'Verleng de periode indien niet gevonden',
        'present' => 'Cadeau',
        'ignore_without_ignition' => 'Negeren als het contact uit staat',
        'installation_date_default_today' => 'Installatiedatum standaard vandaag',
        'phone_verification' => 'Telefoonverificatie',
        'task_set_title' => 'Takenset titel',
        ...
        'inactive' => 'Inactief',
        'sort_column' => 'Standaard sorteerkolom',
        'connection' => 'Verbinding',
        'filename' => 'Bestandsnaam',
        'tokens_count' => 'Tokens tellen',
        'confirmation' => 'Bevestiging',
        'change_password' => 'Wachtwoord wijzigen',
        'new_password' => 'Nieuw wachtwoord',
        'here_political_view' => 'HERE.com politieke visie',
        'unit_type' => 'Parameter eenheidstype',
        'case' => 'Geval',
        'zones' => 'Zones',
        'drivers' => 'Bestuurders',
        'refresh_token' => 'Token vernieuwen',
        'reset_blank' => 'Lege waarde resetten',
        'tags' => 'Labels',
        'is_common' => 'Gewoon',
        'allow_expired_value' => 'Verlopen waarde toestaan',
    ),
    ...
    'json' => 'Het kenmerk :attribute moet een geldige JSON-tekenreeks zijn.',
    'phone' => 'Het :attribute moet een geldig telefoonnummer zijn.',
    'input_placeholder' => 'Invoegen',
    'datepicker_placeholder' => 'Selecteer',
    'select_placeholder' => 'Selecteer',
    'address_placeholder' => 'Selecteer adres',
    'invalid_export_type' => 'Het geselecteerde exporttype is niet geldig.',
    'imei' => 'Ongeldige IMEI, mogelijke tekens: AZ az 0-9 _ # -',
);