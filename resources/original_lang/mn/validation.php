...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Хүүхдийн портууд',
        'send_to_ftp' => 'FTP/SFTP руу илгээх',
        'max_speed' => 'дээд хурд',
        'auto_status_change' => 'Автомат статусын өөрчлөлт',
        'delivery_ac_duration' => 'Хүргэлтийн хугацаа',
        'delivery_ac_radius' => 'Хүргэлтийн радиус',
        'delivery_ac_status' => 'Хүргэлтийн байдал',
        'delivery_ac_started_at' => 'Хүргэлтийн статусын өөрчлөлт эхэлсэн',
        'delivery_ac_finished_at' => 'Хүргэлтийн статусын өөрчлөлт дууссан',
        'pickup_ac_duration' => 'Татаж авах хугацаа',
        'pickup_ac_radius' => 'Татаж авах радиус',
        'pickup_ac_status' => 'Татаж авах байдал',
        'pickup_ac_started_at' => 'Татаж авах статусын өөрчлөлт эхэлсэн',
        'pickup_ac_finished_at' => 'Татаж авах статусын өөрчлөлт дууссан',
        'azure_maps_key' => 'Azure Газрын зургийн түлхүүр',
        'lbs' => 'LBS',
        'skipped' => 'Алгассан',
        'datetime_format' => 'Огноо цагийн формат',
        'acceptable_time_from' => 'Зөвшөөрөгдөх хугацаа',
        'extend_period_if_not_found' => 'Олдохгүй бол хугацааг сунгана уу',
        'present' => 'Одоогийн',
        'ignore_without_ignition' => 'Гал асаах унтраалттай бол үл тоомсорло',
        'installation_date_default_today' => 'Суулгах өдөр нь анхдагчаар өнөөдөр',
        'phone_verification' => 'Утасны баталгаажуулалт',
        'task_set_title' => 'Даалгаврын гарчиг',
        'pickup_time' => 'Татаж авах цаг',
        'delivery_time' => 'Хүргэлтийн хугацаа',
        'location_address' => 'Хаяг',
        'location_time' => 'Цаг хугацаа',
        'date_range' => 'Огнооны хүрээ',
        'inactive' => 'Идэвхгүй',
        'sort_column' => 'Өгөгдмөл эрэмбэлэх багана',
        'connection' => 'Холболт',
        'filename' => 'Файлын нэр',
        'tokens_count' => 'Токен тоолно',
        'confirmation' => 'Баталгаажуулалт',
        'change_password' => 'Нууц үг солих',
        'new_password' => 'Шинэ нууц үг',
        'here_political_view' => 'HERE.com улс төрийн үзэл бодол',
        'unit_type' => 'Параметрийн нэгжийн төрөл',
        'case' => 'Кейс',
        'zones' => 'Бүсүүд',
        'drivers' => 'Жолооч нар',
        'refresh_token' => 'Токеныг шинэчлэх',
        'reset_blank' => 'Хоосон утгыг дахин тохируулах',
        'tags' => 'Шошго',
        'is_common' => 'Нийтлэг',
        'allow_expired_value' => 'Хугацаа нь дууссан утгыг зөвшөөрөх',
    ),
    ...
    'starts_with' => ':attribute дараах зүйлсийн аль нэгээр эхлэх ёстой: :values .',
    'json' => ':attribute хүчинтэй JSON мөр байх ёстой.',
    'phone' => ':attribute хүчинтэй утасны дугаар байх ёстой.',
    'input_placeholder' => 'Оруулах',
    'datepicker_placeholder' => 'Сонго',
    'select_placeholder' => 'Сонго',
    'address_placeholder' => 'Хаяг сонгоно уу',
    'invalid_export_type' => 'Сонгосон экспортын төрөл буруу байна.',
    'imei' => 'Буруу IMEI, боломжит тэмдэгтүүд: AZ az 0-9 _ # -',
);