...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Porturi pentru copii',
        'send_to_ftp' => 'Trimiteți pe FTP/SFTP',
        'max_speed' => 'Viteza maxima',
        'auto_status_change' => 'Schimbarea automată a stării',
        'delivery_ac_duration' => 'Durata de livrare',
        'delivery_ac_radius' => 'Raza de livrare',
        'delivery_ac_status' => 'Stare de livrare',
        'delivery_ac_started_at' => 'A început schimbarea stării livrării',
        'delivery_ac_finished_at' => 'Modificarea stării livrării s-a încheiat',
        'pickup_ac_duration' => 'Durata ridicării',
        'pickup_ac_radius' => 'Raza de preluare',
        'pickup_ac_status' => 'Starea ridicării',
        'pickup_ac_started_at' => 'A început schimbarea stării de ridicare',
        'pickup_ac_finished_at' => 'Modificarea stării ridicării s-a încheiat',
        'azure_maps_key' => 'Cheia Azure Maps',
        'lbs' => 'LBS',
        'skipped' => 'Sărit',
        'datetime_format' => 'Format datetime',
        'acceptable_time_from' => 'Timp acceptabil de la',
        'extend_period_if_not_found' => 'Extindeți perioada dacă nu este găsit',
        'present' => 'Prezent',
        'ignore_without_ignition' => 'Ignorați dacă contactul este oprit',
        'installation_date_default_today' => 'Data instalării astăzi, implicit',
        'phone_verification' => 'Verificare la telefon',
        'task_set_title' => 'Titlul stabilit de sarcini',
        ...
        'inactive' => 'Inactiv',
        'sort_column' => 'Coloana de sortare implicită',
        'connection' => 'Conexiune',
        'filename' => 'Nume de fișier',
        'tokens_count' => 'Jetoanele contează',
        'confirmation' => 'Confirmare',
        'change_password' => 'Schimbaţi parola',
        'new_password' => 'Parolă Nouă',
        'here_political_view' => 'HERE.com viziune politică',
        'unit_type' => 'Tip de unitate de parametri',
        'case' => 'Caz',
        'zones' => 'Zonele',
        'drivers' => 'Șoferii',
        'refresh_token' => 'Jeton de actualizare',
        'reset_blank' => 'Resetează valoarea goală',
        'tags' => 'Etichete',
        'is_common' => 'Comun',
        'allow_expired_value' => 'Permiteți valoarea expirată',
    ),
    ...
    'phone' => ':attribute trebuie să fie un număr de telefon valid.',
    'input_placeholder' => 'Introduce',
    'datepicker_placeholder' => 'Selecta',
    'select_placeholder' => 'Selecta',
    'address_placeholder' => 'Selectați adresa',
    'invalid_export_type' => 'Tipul de export selectat nu este valid.',
    'imei' => 'IMEI nevalid, caractere posibile: AZ az 0-9 _ # -',
);