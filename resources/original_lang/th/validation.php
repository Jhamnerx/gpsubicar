...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'พอร์ตลูก',
        'send_to_ftp' => 'ส่งไปยัง FTP/SFTP',
        'max_speed' => 'ความเร็วสูงสุด',
        'auto_status_change' => 'การเปลี่ยนแปลงสถานะอัตโนมัติ',
        'delivery_ac_duration' => 'ระยะเวลาจัดส่ง',
        'delivery_ac_radius' => 'รัศมีการจัดส่ง',
        'delivery_ac_status' => 'สถานะการจัดส่ง',
        'delivery_ac_started_at' => 'เริ่มการเปลี่ยนแปลงสถานะการจัดส่งแล้ว',
        'delivery_ac_finished_at' => 'การเปลี่ยนแปลงสถานะการจัดส่งเสร็จสิ้น',
        'pickup_ac_duration' => 'ระยะเวลาการรับสินค้า',
        'pickup_ac_radius' => 'รัศมีการรับ',
        'pickup_ac_status' => 'สถานะการรับของ',
        'pickup_ac_started_at' => 'เริ่มเปลี่ยนสถานะการรับสินค้าแล้ว',
        'pickup_ac_finished_at' => 'การเปลี่ยนแปลงสถานะการรับสินค้าเสร็จสิ้น',
        'azure_maps_key' => 'คีย์ Azure Maps',
        'lbs' => 'ปอนด์',
        'skipped' => 'ข้ามไป',
        'datetime_format' => 'รูปแบบวันที่และเวลา',
        'acceptable_time_from' => 'เวลาที่ยอมรับได้ตั้งแต่',
        'extend_period_if_not_found' => 'ขยายระยะเวลาหากไม่พบ',
        'present' => 'ปัจจุบัน',
        'ignore_without_ignition' => 'เพิกเฉยหากปิดสวิตช์กุญแจ',
        'installation_date_default_today' => 'วันที่ติดตั้งวันนี้ตามค่าเริ่มต้น',
        'phone_verification' => 'การยืนยันทางโทรศัพท์',
        'task_set_title' => 'งานกำหนดชื่อหัวข้อ',
        'pickup_time' => 'เวลาในการรับสินค้า',
        'delivery_time' => 'ระยะเวลาในการจัดส่ง',
        'location_address' => 'ที่อยู่',
        'location_time' => 'เวลา',
        'date_range' => 'ช่วงวันที่',
        'inactive' => 'ไม่ทำงาน',
        'sort_column' => 'คอลัมน์การเรียงลำดับเริ่มต้น',
        'connection' => 'การเชื่อมต่อ',
        'filename' => 'ชื่อไฟล์',
        'tokens_count' => 'จำนวนโทเค็น',
        'confirmation' => 'การยืนยัน',
        'change_password' => 'เปลี่ยนรหัสผ่าน',
        'new_password' => 'รหัสผ่านใหม่',
        'here_political_view' => 'มุมมองทางการเมืองของ HERE.com',
        'unit_type' => 'ประเภทหน่วยพารามิเตอร์',
        'case' => 'กรณี',
        'zones' => 'โซน',
        'drivers' => 'ไดรเวอร์',
        'refresh_token' => 'รีเฟรชโทเค็น',
        'reset_blank' => 'รีเซ็ตค่าว่าง',
        'tags' => 'แท็ก',
        'is_common' => 'ทั่วไป',
        'allow_expired_value' => 'อนุญาตให้ค่าหมดอายุ',
    ),
    ...
    'phone' => ':attribute จะต้องเป็นหมายเลขโทรศัพท์ที่ถูกต้อง',
    'input_placeholder' => 'แทรก',
    'datepicker_placeholder' => 'เลือก',
    'select_placeholder' => 'เลือก',
    'address_placeholder' => 'เลือกที่อยู่',
    'invalid_export_type' => 'ประเภทการส่งออกที่เลือกไม่ถูกต้อง',
    'imei' => 'IMEI ไม่ถูกต้อง อักขระที่เป็นไปได้: AZ az 0-9 _ # -',
);