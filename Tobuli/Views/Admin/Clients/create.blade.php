    ...
    <div class="tab-content">
        <div id="client-add-form-main" class="tab-pane active">
                        ...
                        <div class="form-group" data-disablable="#group_id;hide-disable;2 3 5">
                            ...
                            <div class="input-group">
                                <div class="checkbox input-group-btn">
                                    ...
                                    {!! Form::checkbox('enable_manager_id', 1, false, ['id' => 'enable_manager_id']) !!}
                                    {!! Form::label(null) !!}
                                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('expiration_date', is_null($expiration_days) ? '' : Formatter::time()->convert(date('Y-m-d H:i:s',strtotime('+'.$expiration_days.' days'))), ['class' => 'form-control datetimepicker enable_expiration_date lock', 'style' => 'z-index: 1']) !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                @if (settings('main_settings.phone_verification'))
                    <div class="checkbox">
                        {!! Form::checkbox('phone_verification', 1, 1) !!}
                        {!! Form::label(null, trans('front.send_verification_phone')) !!}
                    </div>
                @endif
            </div>
        </div>
