...
@section('body')
    ...
    <div class="tab-content">
        <div id="client-edit-form-main" class="tab-pane active">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    @if (Auth::User()->isAdmin() || Auth::User()->isSupervisor())
                        <div class="form-group" data-disablable="#group_id;hide-disable;2 3 5">
                            {!! Form::label('manager_id', trans('validation.attributes.manager_id').'*:') !!}

                            <div class="input-group">
                                <div class="checkbox input-group-btn">
                                    {!! Form::hidden('enable_manager_id', 0) !!}
                                    {!! Form::checkbox('enable_manager_id', 1, $item->manager_id, ['id' => 'enable_manager_id']) !!}
                                    {!! Form::label(null) !!}
                                </div>

                                <div class="field_manager_id" data-disablable="#enable_manager_id;disable">
                                    {!! Form::select('manager_id', [], null, [
                                        'class' => "form-control",
                                        'title' => trans('front.none'),
                                        'data-live-search' => 'true',
                                        'data-ajax' => route('admin.clients.managers'),
                                        'data-selected' => $item->manager_id
                                    ]) !!}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('expiration_date', $item->subscription_expiration == '0000-00-00 00:00:00' ? NULL : Formatter::time()->convert($item->subscription_expiration), ['class' => 'form-control datetimepicker', 'style' => 'z-index: 1']) !!}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if (config('google2fa.enabled') && $item->is2faEnabled())
                <div class="form-group">
                    <h4>{{ trans('front.setup_2fa') }}</h4>
                </div>

                <div class="form-group">
                    <div class="checkbox">
                        {!! Form::checkbox('reset_2fa') !!}
                        {!! Form::label(null, trans('front.reset')) !!}
                    </div>
                </div>
            @endif
        </div>
