...
return array(
    ...
    'attributes'  => array(
        ...
        'mtc' => 'Retransmitir a SUTRAN (MTC)',
        'mininter' => 'Retransmitir a MININTER',
        'mininter_type' => 'Tipo de unidad MININTER',
        'is_municipalidad' => 'Habilitar retransmisión MININTER (municipalidad / comisaría)',
        'ubigeo_muni' => 'Ubigeo',
        'token_muni' => 'ID de municipalidad / ID de transmisión',
        'codigo_comisaria' => 'Código de comisaría',
        'vin' => 'VIN',
        ...
        'unit_type' => 'Tipo de unidad de parámetro',
        'case' => 'Caso',
        'zones' => 'Zonas',
        'drivers' => 'Conductores',
        'refresh_token' => 'Token de actualización',
        'reset_blank' => 'Restablecer valor en blanco',
        'tags' => 'Etiquetas',
        'is_common' => 'Común',
        'allow_expired_value' => 'Permitir valor caducado',
    ),
    ...
    'imei' => 'IMEI no válido, caracteres posibles: AZ az 0-9 _ # -',
);