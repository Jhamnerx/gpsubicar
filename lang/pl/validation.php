...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Porty podrzędne',
        'send_to_ftp' => 'Wyślij do FTP/SFTP',
        'max_speed' => 'Maksymalna prędkość',
        'auto_status_change' => 'Automatyczna zmiana statusu',
        'delivery_ac_duration' => 'Czas dostawy',
        'delivery_ac_radius' => 'Promień dostawy',
        'delivery_ac_status' => 'Status przesyłki',
        'delivery_ac_started_at' => 'Rozpoczęto zmianę statusu dostawy',
        'delivery_ac_finished_at' => 'Zmiana statusu dostawy została zakończona',
        'pickup_ac_duration' => 'Czas odbioru',
        'pickup_ac_radius' => 'Promień odbioru',
        'pickup_ac_status' => 'Stan odbioru',
        'pickup_ac_started_at' => 'Rozpoczęto zmianę statusu odbioru',
        'pickup_ac_finished_at' => 'Zmiana statusu odbioru zakończona',
        'azure_maps_key' => 'Klucz Azure Maps',
        'lbs' => 'LBS',
        'skipped' => 'Pominięto',
        'datetime_format' => 'Format daty i godziny',
        'acceptable_time_from' => 'Dopuszczalny czas od',
        'extend_period_if_not_found' => 'Przedłuż okres, jeśli nie znaleziono',
        'present' => 'Obecny',
        'ignore_without_ignition' => 'Zignoruj, jeśli zapłon jest wyłączony',
        'installation_date_default_today' => 'Domyślnie data instalacji ustawiona na dziś',
        'phone_verification' => 'Weryfikacja telefoniczna',
        'task_set_title' => 'Tytuł zestawu zadań',
        ...
        'inactive' => 'Nieaktywny',
        'sort_column' => 'Domyślna kolumna sortowania',
        'connection' => 'Połączenie',
        'filename' => 'Nazwa pliku',
        'tokens_count' => 'Liczba żetonów',
        'confirmation' => 'Potwierdzenie',
        'change_password' => 'Zmień hasło',
        'new_password' => 'Nowe hasło',
        'here_political_view' => 'Poglądy polityczne HERE.com',
        'unit_type' => 'Typ jednostki parametru',
        'case' => 'Sprawa',
        'zones' => 'Strefy',
        'drivers' => 'Kierowcy',
        'refresh_token' => 'Odśwież token',
        'reset_blank' => 'Zresetuj pustą wartość',
        'tags' => 'Tagi',
        'is_common' => 'Wspólny',
        'allow_expired_value' => 'Zezwalaj na wygasłą wartość',
    ),
    ...
    'starts_with' => 'Opcja :attribute musi zaczynać się od jednej z następujących wartości: :values .',
    'json' => 'Parametr :attribute musi być prawidłowym ciągiem JSON.',
    'phone' => 'Parametr :attribute musi zawierać prawidłowy numer telefonu.',
    'input_placeholder' => 'Wstawić',
    'datepicker_placeholder' => 'Wybierać',
    'select_placeholder' => 'Wybierać',
    'address_placeholder' => 'Wybierz adres',
    'invalid_export_type' => 'Wybrany typ eksportu jest nieprawidłowy.',
    'imei' => 'Nieprawidłowy IMEI, możliwe znaki: AZ az 0-9 _ # -',
);