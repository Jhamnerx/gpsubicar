...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'চাইল্ড পোর্ট',
        'send_to_ftp' => 'FTP/SFTP-এ পাঠান',
        'max_speed' => 'সর্বোচ্চ গতি',
        'auto_status_change' => 'স্বয়ংক্রিয় অবস্থা পরিবর্তন',
        'delivery_ac_duration' => 'ডেলিভারি সময়কাল',
        'delivery_ac_radius' => 'ডেলিভারি ব্যাসার্ধ',
        'delivery_ac_status' => 'ডেলিভারি অবস্থা',
        'delivery_ac_started_at' => 'ডেলিভারি অবস্থা পরিবর্তন শুরু',
        'delivery_ac_finished_at' => 'ডেলিভারি স্থিতি পরিবর্তন সমাপ্ত',
        'pickup_ac_duration' => 'পিকআপের সময়কাল',
        'pickup_ac_radius' => 'পিকআপ ব্যাসার্ধ',
        'pickup_ac_status' => 'পিকআপ স্ট্যাটাস',
        'pickup_ac_started_at' => 'পিকআপ স্ট্যাটাস পরিবর্তন শুরু হয়েছে',
        'pickup_ac_finished_at' => 'পিক-আপ স্ট্যাটাস পরিবর্তন শেষ',
        'azure_maps_key' => 'Azure Maps কী',
        'lbs' => 'এলবিএস',
        'skipped' => 'এড়িয়ে গেছে',
        'datetime_format' => 'তারিখ সময় বিন্যাস',
        'acceptable_time_from' => 'থেকে গ্রহণযোগ্য সময়',
        'extend_period_if_not_found' => 'না পাওয়া গেলে মেয়াদ বাড়ান',
        'present' => 'বর্তমান',
        'ignore_without_ignition' => 'ইগনিশন বন্ধ থাকলে উপেক্ষা করুন',
        'installation_date_default_today' => 'ডিফল্টরূপে আজ ইনস্টলেশন তারিখ',
        'phone_verification' => 'ফোন যাচাইকরণ',
        'task_set_title' => 'টাস্ক সেটের শিরোনাম',
        'pickup_time' => 'পিকআপের সময়',
        'delivery_time' => 'ডেলিভারি সময়',
        'location_address' => 'জানুন',
        'location_time' => 'সময়',
        'date_range' => 'তারিখের পরিসর',
        'inactive' => 'নিষ্ক্রিয়',
        'sort_column' => 'ডিফল্ট সাজানোর কলাম',
        'connection' => 'সংযোগ',
        'filename' => 'ফাইলের নাম',
        'tokens_count' => 'টোকেন গণনা',
        'confirmation' => 'নিশ্চিতকরণ',
        'change_password' => 'পাসওয়ার্ড পরিবর্তন করুন',
        'new_password' => 'নতুন পাসওয়ার্ড',
        'here_political_view' => 'HERE.com এর রাজনৈতিক দৃষ্টিভঙ্গি',
        'unit_type' => 'প্যারামিটার ইউনিটের ধরণ',
        'case' => 'মামলা',
        'zones' => 'অঞ্চল',
        'drivers' => 'ড্রাইভার',
        'refresh_token' => 'টোকেন রিফ্রেশ করুন',
        'reset_blank' => 'ফাঁকা মান রিসেট করুন',
        'tags' => 'ট্যাগ',
        'is_common' => 'সাধারণ',
        'allow_expired_value' => 'মেয়াদোত্তীর্ণ মান অনুমোদন করুন',
    ),
    ...
    'phone' => ':attribute একটি বৈধ ফোন নম্বর হতে হবে।',
    'input_placeholder' => 'ঢোকান',
    'datepicker_placeholder' => 'নির্বাচন করুন',
    'select_placeholder' => 'নির্বাচন করুন',
    'address_placeholder' => 'ঠিকানা নির্বাচন করুন',
    'invalid_export_type' => 'নির্বাচিত রপ্তানির ধরণটি বৈধ নয়।',
    'imei' => 'অবৈধ IMEI, সম্ভাব্য অক্ষর: AZ az 0-9 _ # -',
);