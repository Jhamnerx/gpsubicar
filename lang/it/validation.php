...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Porte per bambini',
        'send_to_ftp' => 'Invia a FTP/SFTP',
        'max_speed' => 'Massima velocità',
        'auto_status_change' => 'Modifica automatica dello stato',
        'delivery_ac_duration' => 'Durata della consegna',
        'delivery_ac_radius' => 'Raggio di consegna',
        'delivery_ac_status' => 'Stato della consegna',
        'delivery_ac_started_at' => 'È iniziata la modifica dello stato di consegna',
        'delivery_ac_finished_at' => 'Modifica dello stato di consegna terminata',
        'pickup_ac_duration' => 'Durata del ritiro',
        'pickup_ac_radius' => 'Raggio di raccolta',
        'pickup_ac_status' => 'Stato del ritiro',
        'pickup_ac_started_at' => 'È iniziata la modifica dello stato del ritiro',
        'pickup_ac_finished_at' => 'Modifica dello stato del ritiro terminata',
        'azure_maps_key' => 'Chiave di Azure Maps',
        'lbs' => 'Libbre',
        'skipped' => 'Saltato',
        'datetime_format' => 'Formato data/ora',
        'acceptable_time_from' => 'Tempo accettabile da',
        'extend_period_if_not_found' => 'Estendi il periodo se non trovato',
        'present' => 'Presente',
        'ignore_without_ignition' => 'Ignora se l\'accensione è spenta',
        'installation_date_default_today' => 'Data di installazione predefinita oggi',
        'phone_verification' => 'Verifica telefonica',
        'task_set_title' => 'Titolo del set di attività',
        ...
        'inactive' => 'Inattivo',
        'sort_column' => 'Colonna di ordinamento predefinita',
        'connection' => 'Connessione',
        'filename' => 'Nome del file',
        'tokens_count' => 'I token contano',
        'confirmation' => 'Conferma',
        'change_password' => 'Cambiare la password',
        'new_password' => 'Nuova password',
        'here_political_view' => 'HERE.com visione politica',
        'unit_type' => 'Tipo di unità di parametro',
        'case' => 'Caso',
        'zones' => 'Zone',
        'drivers' => 'Autisti',
        'refresh_token' => 'Aggiorna token',
        'reset_blank' => 'Reimposta il valore vuoto',
        'tags' => 'Etichette',
        'is_common' => 'Comune',
        'allow_expired_value' => 'Consenti valore scaduto',
    ),
    ...
    'phone' => 'L\' :attribute deve essere un numero di telefono valido.',
    'input_placeholder' => 'Inserire',
    'datepicker_placeholder' => 'Selezionare',
    'select_placeholder' => 'Selezionare',
    'address_placeholder' => 'Seleziona indirizzo',
    'invalid_export_type' => 'Il tipo di esportazione selezionato non è valido.',
    'imei' => 'IMEI non valido, caratteri possibili: AZ az 0-9 _ # -',
);