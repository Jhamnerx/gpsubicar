...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Dječji priključci',
        'send_to_ftp' => 'Pošalji na FTP/SFTP',
        'max_speed' => 'Maksimalna brzina',
        'auto_status_change' => 'Automatska promjena statusa',
        'delivery_ac_duration' => 'Trajanje isporuke',
        'delivery_ac_radius' => 'Radijus isporuke',
        'delivery_ac_status' => 'Status isporuke',
        'delivery_ac_started_at' => 'Započela je promjena statusa isporuke',
        'delivery_ac_finished_at' => 'Promjena statusa isporuke je završena',
        'pickup_ac_duration' => 'Trajanje preuzimanja',
        'pickup_ac_radius' => 'Radijus preuzimanja',
        'pickup_ac_status' => 'Status preuzimanja',
        'pickup_ac_started_at' => 'Započela je promjena statusa preuzimanja',
        'pickup_ac_finished_at' => 'Promjena statusa preuzimanja je završena',
        'azure_maps_key' => 'Ključ Azure Maps',
        'lbs' => 'LBS',
        'skipped' => 'Preskočeno',
        'datetime_format' => 'Format datuma i vremena',
        'acceptable_time_from' => 'Prihvatljivo vrijeme od',
        'extend_period_if_not_found' => 'Produžite razdoblje ako nije pronađeno',
        'present' => 'Predstaviti',
        'ignore_without_ignition' => 'Ignorirajte ako je paljenje isključeno',
        'installation_date_default_today' => 'Današnji datum instalacije prema zadanim postavkama',
        'phone_verification' => 'Telefonska potvrda',
        'task_set_title' => 'Naslov skupa zadataka',
        'pickup_time' => 'Vrijeme preuzimanja',
        'delivery_time' => 'Vrijeme isporuke',
        'location_address' => 'Adresa',
        'location_time' => 'Vrijeme',
        'date_range' => 'Razdoblje',
        'inactive' => 'Neaktivan',
        'sort_column' => 'Zadani stupac sortiranja',
        'connection' => 'Veza',
        'filename' => 'Naziv datoteke',
        'tokens_count' => 'Tokeni se broje',
        'confirmation' => 'Potvrda',
        'change_password' => 'Promjena lozinke',
        'new_password' => 'Nova lozinka',
        'here_political_view' => 'OVDJE.com politički stav',
        'unit_type' => 'Vrsta jedinice parametra',
        'case' => 'Spis',
        'zones' => 'Zone',
        'drivers' => 'Vozači',
        'refresh_token' => 'Osvježi token',
        'reset_blank' => 'Resetiraj praznu vrijednost',
        'tags' => 'Oznake',
        'is_common' => 'Uobičajeno',
        'allow_expired_value' => 'Dopusti isteklu vrijednost',
    ),
    ...
    'phone' => ':attribute mora biti važeći telefonski broj.',
    'input_placeholder' => 'Umetnuti',
    'datepicker_placeholder' => 'Odaberite',
    'select_placeholder' => 'Odaberite',
    'address_placeholder' => 'Odaberite adresu',
    'invalid_export_type' => 'Odabrana vrsta izvoza nije važeća.',
    'imei' => 'Nevažeći IMEI, mogući znakovi: AZ az 0-9 _ # -',
);