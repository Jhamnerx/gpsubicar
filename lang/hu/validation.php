...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Gyermek portok',
        'send_to_ftp' => 'Küldés FTP/SFTP-re',
        'max_speed' => 'Teljes sebesség',
        'auto_status_change' => 'Automatikus állapotváltás',
        'delivery_ac_duration' => 'Szállítási időtartam',
        'delivery_ac_radius' => 'Szállítási sugár',
        'delivery_ac_status' => 'Kiszállítás állapota',
        'delivery_ac_started_at' => 'Megkezdődött a szállítási állapot változása',
        'delivery_ac_finished_at' => 'A szállítási állapot módosítása befejeződött',
        'pickup_ac_duration' => 'Az átvétel időtartama',
        'pickup_ac_radius' => 'Felvételi sugár',
        'pickup_ac_status' => 'Átvétel állapota',
        'pickup_ac_started_at' => 'Elindult az átvétel állapotának változása',
        'pickup_ac_finished_at' => 'Az átvétel állapotának módosítása befejeződött',
        'azure_maps_key' => 'Azure Maps kulcs',
        'lbs' => 'LBS',
        'skipped' => 'Kihagyva',
        'datetime_format' => 'Dátum és idő formátum',
        'acceptable_time_from' => 'Elfogadható időpont tól',
        'extend_period_if_not_found' => 'Hosszabbítsa meg az időtartamot, ha nem található',
        'present' => 'Jelenlegi',
        'ignore_without_ignition' => 'Hagyja figyelmen kívül, ha a gyújtás ki van kapcsolva',
        'installation_date_default_today' => 'Alapértelmezés szerint a mai telepítés dátuma',
        'phone_verification' => 'Telefonos ellenőrzés',
        'task_set_title' => 'Feladatkészlet címe',
        'pickup_time' => 'Felvételi idő',
        'delivery_time' => 'Szállítási idő',
        'location_address' => 'Cím',
        'location_time' => 'Idő',
        'date_range' => 'Dátumtartomány',
        'inactive' => 'Inaktív',
        'sort_column' => 'Alapértelmezett rendezési oszlop',
        'connection' => 'Kapcsolat',
        'filename' => 'Fájlnév',
        'tokens_count' => 'A tokenek számítanak',
        'confirmation' => 'Megerősítés',
        'change_password' => 'Jelszó módosítása',
        'new_password' => 'Új jelszó',
        'here_political_view' => 'HERE.com politikai nézet',
        'unit_type' => 'Paraméter egység típusa',
        'case' => 'Ügy',
        'zones' => 'Zónák',
        'drivers' => 'Drivers',
        'refresh_token' => 'Frissítési token',
        'reset_blank' => 'Üres érték visszaállítása',
        'tags' => 'Címkék',
        'is_common' => 'Közös',
        'allow_expired_value' => 'Lejárt érték engedélyezése',
    ),
    ...
    'phone' => 'Az :attribute érvényes telefonszámnak kell lennie.',
    'input_placeholder' => 'Beszúrás',
    'datepicker_placeholder' => 'Válassza ki',
    'select_placeholder' => 'Válassza ki',
    'address_placeholder' => 'Válasszon címet',
    'invalid_export_type' => 'A kiválasztott exportálási típus érvénytelen.',
    'imei' => 'Érvénytelen IMEI, lehetséges karakterek: AZ az 0-9 _ # -',
);