...
return array(
    ...
    'attributes'  => array(
        ...
        'mtc' => 'Forward to SUTRAN (MTC)',
        'mininter' => 'Forward to MININTER',
        'mininter_type' => 'MININTER unit type',
        'is_municipalidad' => 'Enable MININTER forwarding (municipality / police station)',
        'ubigeo_muni' => 'Ubigeo',
        'token_muni' => 'Municipality ID / transmission ID',
        'codigo_comisaria' => 'Police station code',
        'vin' => 'VIN',
        ...
        'send_to_ftp' => 'Send to FTP/SFTP',
        'max_speed' => 'Max speed',
        'auto_status_change' => 'Auto status change',
        'delivery_ac_duration' => 'Delivery duration',
        'delivery_ac_radius' => 'Delivery radius',
        'delivery_ac_status' => 'Delivery status',
        'delivery_ac_started_at' => 'Delivery status change started',
        'delivery_ac_finished_at' => 'Delivery status change finished',
        'pickup_ac_duration' => 'Pickup duration',
        'pickup_ac_radius' => 'Pickup radius',
        'pickup_ac_status' => 'Pickup status',
        'pickup_ac_started_at' => 'Pickup status change started',
        'pickup_ac_finished_at' => 'Pickup status change finished',
        'azure_maps_key' => 'Azure Maps key',
        'lbs' => 'LBS',
        'skipped' => 'Skipped',
        'datetime_format' => 'Datetime format',
        'acceptable_time_from' => 'Acceptable time from',
        'extend_period_if_not_found' => 'Extend period if not found',
        'present' => 'Present',
        'ignore_without_ignition' => 'Ignore if ignition is off',
        'installation_date_default_today' => 'Installation date today by default',
        'phone_verification' => 'Phone verification',
        'task_set_title' => 'Tasks set title',
        ...
        'here_political_view' => 'HERE.com political view',
        'unit_type' => 'Parameter unit type',
        'case' => 'Case',
        'zones' => 'Zones',
        'drivers' => 'Drivers',
        'refresh_token' => 'Refresh token',
        'reset_blank' => 'Reset blank value',
        'tags' => 'Tags',
        'is_common' => 'Common',
        'allow_expired_value' => 'Allow expired value',
    ),
    ...
    'datepicker_placeholder' => 'Select',
    'select_placeholder' => 'Select',
    'address_placeholder' => 'Select address',
    'invalid_export_type' => 'Selected export type is not valid.',
    'imei' => 'Invalid IMEI, possible characters: A-Z a-z 0-9 _ # -',
);