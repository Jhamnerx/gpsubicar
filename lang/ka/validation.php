...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'ბავშვთა პორტები',
        'send_to_ftp' => 'გაგზავნეთ FTP/SFTP-ზე',
        'max_speed' => 'მაქსიმალური სიჩქარე',
        'auto_status_change' => 'ავტომატური სტატუსის შეცვლა',
        'delivery_ac_duration' => 'მიწოდების ხანგრძლივობა',
        'delivery_ac_radius' => 'მიწოდების რადიუსი',
        'delivery_ac_status' => 'Მიტანის სტატუსი',
        'delivery_ac_started_at' => 'მიწოდების სტატუსის შეცვლა დაიწყო',
        'delivery_ac_finished_at' => 'მიწოდების სტატუსის ცვლილება დასრულდა',
        'pickup_ac_duration' => 'პიკაპის ხანგრძლივობა',
        'pickup_ac_radius' => 'პიკაპის რადიუსი',
        'pickup_ac_status' => 'პიკაპის სტატუსი',
        'pickup_ac_started_at' => 'პიკაპის სტატუსის შეცვლა დაიწყო',
        'pickup_ac_finished_at' => 'პიკაპის სტატუსის ცვლილება დასრულდა',
        'azure_maps_key' => 'Azure Maps გასაღები',
        'lbs' => 'LBS',
        'skipped' => 'გამოტოვებული',
        'datetime_format' => 'თარიღის დროის ფორმატი',
        'acceptable_time_from' => 'მისაღები დრო დან',
        'extend_period_if_not_found' => 'ვადის გახანგრძლივება თუ ვერ მოიძებნა',
        'present' => 'აწმყო',
        'ignore_without_ignition' => 'იგნორირება, თუ ანთება გამორთულია',
        'installation_date_default_today' => 'ინსტალაციის თარიღი დღეს ნაგულისხმევად',
        'phone_verification' => 'ტელეფონის გადამოწმება',
        'task_set_title' => 'ამოცანების ნაკრების სათაური',
        'pickup_time' => 'პიკაპის დრო',
        'delivery_time' => 'მიწოდების დრო',
        'location_address' => 'მისამართი',
        'location_time' => 'დრო',
        'date_range' => 'თარიღის დიაპაზონი',
        'inactive' => 'არააქტიური',
        'sort_column' => 'ნაგულისხმევი სორტირების სვეტი',
        'connection' => 'კავშირი',
        'filename' => 'ფაილის სახელი',
        'tokens_count' => 'ტოკენების რაოდენობა',
        'confirmation' => 'დადასტურება',
        'change_password' => 'პაროლის შეცვლა',
        'new_password' => 'ახალი პაროლი',
        'here_political_view' => 'HERE.com პოლიტიკური შეხედულება',
        'unit_type' => 'პარამეტრის ერთეულის ტიპი',
        'case' => 'საქმე',
        'zones' => 'ზონები',
        'drivers' => 'მძღოლები',
        'refresh_token' => 'ტოკენის განახლება',
        'reset_blank' => 'ცარიელი მნიშვნელობის გადაყენება',
        'tags' => 'თეგები',
        'is_common' => 'საერთო',
        'allow_expired_value' => 'ვადაგასული მნიშვნელობის დაშვება',
    ),
    ...
    'starts_with' => ':attribute უნდა დაიწყოს ერთ-ერთი შემდეგით: :values .',
    'json' => ':attribute უნდა იყოს სწორი JSON სტრიქონი.',
    'phone' => ':attribute უნდა იყოს სწორი ტელეფონის ნომერი.',
    'input_placeholder' => 'ჩასმა',
    'datepicker_placeholder' => 'აირჩიეთ',
    'select_placeholder' => 'აირჩიეთ',
    'address_placeholder' => 'აირჩიეთ მისამართი',
    'invalid_export_type' => 'არჩეული ექსპორტის ტიპი არასწორია.',
    'imei' => 'არასწორი IMEI, შესაძლო სიმბოლოები: AZ az 0-9 _ # -',
);