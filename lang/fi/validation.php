...
return array(
    ...
    'attributes'  => array(
        ...
        'child_ports' => 'Lapsiportit',
        'send_to_ftp' => 'Lähetä FTP/SFTP:hen',
        'max_speed' => 'Maksiminopeus',
        'auto_status_change' => 'Automaattinen tilanmuutos',
        'delivery_ac_duration' => 'Toimituksen kesto',
        'delivery_ac_radius' => 'Toimitussäde',
        'delivery_ac_status' => 'Toimituksen tila',
        'delivery_ac_started_at' => 'Toimituksen tilan muutos aloitettu',
        'delivery_ac_finished_at' => 'Toimituksen tilan muutos valmis',
        'pickup_ac_duration' => 'Noudon kesto',
        'pickup_ac_radius' => 'Noudon säde',
        'pickup_ac_status' => 'Noudon tila',
        'pickup_ac_started_at' => 'Noudon tilan muutos aloitettu',
        'pickup_ac_finished_at' => 'Noudon tilan muutos valmis',
        'azure_maps_key' => 'Azure Maps -avain',
        'lbs' => 'LBS',
        'skipped' => 'Ohitettu',
        'datetime_format' => 'Päivämäärän ja ajan muoto',
        'acceptable_time_from' => 'Hyväksytty aika alkaen',
        'extend_period_if_not_found' => 'Pidennä ajanjaksoa, jos sitä ei löydy',
        'present' => 'Esittää',
        'ignore_without_ignition' => 'Ohita, jos sytytysvirta on pois päältä',
        'installation_date_default_today' => 'Oletuksena asennuspäivä tänään',
        'phone_verification' => 'Puhelinvahvistus',
        'task_set_title' => 'Tehtävien otsikko',
        ...
        'sort_column' => 'Oletuslajittelusarake',
        'connection' => 'Yhteys',
        'filename' => 'Tiedoston nimi',
        'tokens_count' => 'Tokenit laskevat',
        'confirmation' => 'Vahvistus',
        'change_password' => 'Vaihda salasana',
        'new_password' => 'Uusi salasana',
        'here_political_view' => 'HERE.com poliittinen näkemys',
        'unit_type' => 'Parametriyksikön tyyppi',
        'case' => 'Asia',
        'zones' => 'Alueet',
        'drivers' => 'Kuljettajat',
        'refresh_token' => 'Päivitä tunnus',
        'reset_blank' => 'Palauta tyhjä arvo',
        'tags' => 'Tunnisteet',
        'is_common' => 'Yleinen',
        'allow_expired_value' => 'Salli vanhentunut arvo',
    ),
    ...
    'phone' => 'Attribuutin :attribute on oltava kelvollinen puhelinnumero.',
    'input_placeholder' => 'Lisää',
    'datepicker_placeholder' => 'Valitse',
    'select_placeholder' => 'Valitse',
    'address_placeholder' => 'Valitse osoite',
    'invalid_export_type' => 'Valittu vientityyppi ei kelpaa.',
    'imei' => 'Virheellinen IMEI, mahdolliset merkit: AZ az 0-9 _ # -',
);